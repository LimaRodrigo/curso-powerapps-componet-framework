...
export class PCFSeletor implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        const props: IMainProps = { context: context, setOutputChanges: this.setOutputChanges.bind(this) };
    ...
    /**
     * Metodo para atualizar a data da última validação positiva
     * acionado pelo componente Main
